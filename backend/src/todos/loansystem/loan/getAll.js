...
// ATM only works from loan, must add handling to other tables aswell
...
export default async (ctx) => {
  ...
  const orderBy = parseSortQuery({
    urlSortQuery: sort,
    whitelist: ['id', 'laite_id', 'lainaaja_id', 'luovutus_id', 'vastaanotto_id', 'lainaus_pvm', 'era_pvm', 'palautus_pvm', 'kunto_palautettaessa'],
  });
